...
• Payment Portal: Integrates Tunisia's local payment gateway Flouci.`,
      ...
      images: [
        '/Portfolio_hamza/assiette-main.jpg',
        '/Portfolio_hamza/assiette-2.jpg',
        '/Portfolio_hamza/assiette-3.jpg',
      ],
      video: null,
      liveUrl: null,
...
• Analytics dashboard for practice insights`,
      ...
      images: [
        '/Portfolio_hamza/cabinet-main.jpg',
        '/Portfolio_hamza/cabinet-2.jpg',
        '/Portfolio_hamza/cabinet-3.jpg',
      ],
      video: null,
      liveUrl: null,
      githubUrl: 'https://github.com/hamzabenmarwen',
...
• Dockerized deployment for local and cloud environments`,
      ...
      images: [
        '/Portfolio_hamza/apv-main.jpg',
        '/Portfolio_hamza/apv-2.jpg',
        '/Portfolio_hamza/apv-3.jpg',
      ],
      video: null,
      liveUrl: null,
      githubUrl: 'https://github.com/hamzabenmarwen',
...
• Docker-compose configurations for orchestrating services`,
      ...
      images: [
        '/Portfolio_hamza/ventes-main.jpg',
        '/Portfolio_hamza/ventes-2.jpg',
        '/Portfolio_hamza/ventes-3.jpg',
      ],
      video: null,
      liveUrl: null,
      githubUrl: 'https://github.com/hamzabenmarwen',
...
• EmailJS contact form integration`,
      ...
      images: [
        '/Portfolio_hamza/portfolio-main.jpg',
        '/Portfolio_hamza/portfolio-2.jpg',
        '/Portfolio_hamza/portfolio-3.jpg',
      ],
      video: null,
...
• Performance analytics and scoreboard tables`,
      ...
      images: [
        '/Portfolio_hamza/quiz-main.jpg',
        '/Portfolio_hamza/quiz-2.jpg',
        '/Portfolio_hamza/quiz-3.jpg',
      ],
      video: null,
      liveUrl: null,
      githubUrl: 'https://github.com/hamzabenmarwen',
...
• Role-based login for librarians and library members`,
      ...
      images: [
        '/Portfolio_hamza/biblio-main.jpg',
        '/Portfolio_hamza/biblio-2.jpg',
        '/Portfolio_hamza/biblio-3.jpg',
      ],
      video: null,
      liveUrl: null,
      githubUrl: 'https://github.com/hamzabenmarwen',
...
• Secure role-based credentials (HR Managers, Employees)`,
      ...
      images: [
        '/Portfolio_hamza/hr-main.jpg',
        '/Portfolio_hamza/hr-2.jpg',
        '/Portfolio_hamza/hr-3.jpg',
      ],
      video: null,
      liveUrl: null,
      githubUrl: 'https://github.com/hamzabenmarwen',
